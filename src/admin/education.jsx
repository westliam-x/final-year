...
const Education = () => {
    ...
    const businesses = [
        { name: 'Business One', documents: 'Accreditation, Curriculum' },
        { name: 'Business Two', documents: 'Accreditation, Curriculum' },
        { name: 'Business Three', documents: 'Accreditation, Curriculum' },
        { name: 'Business Four', documents: 'Accreditation, Curriculum' },
        { name: 'Business Five', documents: 'Accreditation, Curriculum' },
        { name: 'Business Six', documents: 'Accreditation, Curriculum' },
        { name: 'Business Seven', documents: 'Accreditation, Curriculum' },
        { name: 'Business Eight', documents: 'Accreditation, Curriculum' },
        { name: 'Business Nine', documents: 'Accreditation, Curriculum' },
        { name: 'Business Ten', documents: 'Accreditation, Curriculum' },
    ];
    ...
    return (
        <div className="flex h-screen">
            ...
            <div className="flex-1 p-6 bg-gray-100 overflow-auto">
                <h2 className="text-2xl font-bold mb-4">Approved Learning Institutions</h2>
